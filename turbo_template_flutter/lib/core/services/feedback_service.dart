...
import '../widgets/tu_button.dart';
import '../widgets/tu_ok_cancel_dialog.dart';
import '../widgets/tu_ok_dialog.dart';
...
// TODO(codaveto): Implement | 18/04/2024
  ...
  Future<bool?> showOkCancelDialog({
    ...
    BuildContext? context,
    TuButtonType okButtonType = TuButtonType.okButtonDefault,
    TuButtonType cancelButtonType = TuButtonType.cancelButtonDefault,
  }) async {
    final localContext = _localContextWithErrorHandling(context);
