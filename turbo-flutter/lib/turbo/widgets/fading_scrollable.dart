...
import 'package:turbo_template/turbo/extensions/animation_value_extension.dart';
import 'package:turbo_template/turbo/extensions/context_extension.dart';
import 'package:turbo_template/turbo/utils/notifier.dart';
...
class _FadingScrollableState extends State<FadingScrollable> {
  ...
  late final color = widget.color ?? context.t.colors.background;
