...
import '../../../core/abstracts/sync_service.dart';
import '../../../core/annotations/called_by_mutex.dart';
import '../../../core/exceptions/unexpected_null_exception.dart';
        ...
        run: (unlock) async {
          try {
            ...
            if (user != null) {
              ...
              if (_localStorageService.isInitialised) {
