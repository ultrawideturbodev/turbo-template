    ...
    return Center(
      child: TurboCard(
        ...
        margin: EdgeInsets.only(
          ...
          bottom: (context.t.sizes.bottomSafeAreaWithMinimum + horizontalPadding)
        ...
        child: Column(
          ...
          children: [
            if (widget.content != null)
              ...
              Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      widget.title!,
                      style: context.t.texts.dialogHeader,
                      maxLines: 2,
              ...
              const Gap(16),
              Text(widget.message!, style: context.t.texts.label),
              const Gap(16),
            ],
            Wrap(
