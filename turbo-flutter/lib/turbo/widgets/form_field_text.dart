...
class _FormFieldTextState extends State<FormFieldText> {
  ...
  Widget build(BuildContext context) {
    ...
    final iconColor = context.t.colors.formFieldText;
    final cursorColor = context.t.colors.formFieldText;
    ...
    final backgroundColor = switch (isDisabled) {
      false => context.t.colors.activeFormFieldBackground,
      true => context.t.colors.inactiveFormFieldBackground,
    };
    final label = widget.label;
    final borderRadius = context.t.config.bottomSafeAreaMinimum;
    final borderColor = context.t.colors.formFieldBorder;
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          focusedBorder: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(borderRadius),
                            borderSide: BorderSide(
                              color: context.t.colors.activeFormFieldBorder,
