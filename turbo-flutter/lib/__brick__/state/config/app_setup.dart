...
import 'package:{{packageName.snakeCase()}}/auth/forms/create_username_form.dart';
import 'package:{{packageName.snakeCase()}}/auth/routing/auth_step_router.dart';
import 'package:{{packageName.snakeCase()}}/auth/views/accept_privacy/accept_privacy_view_model.dart';
import 'package:{{packageName.snakeCase()}}/auth/views/create_username/create_username_view_model.dart';
import 'package:{{packageName.snakeCase()}}/auth/views/verify_email/verify_email_view_model.dart';
import 'package:{{packageName.snakeCase()}}/feedback/services/dialog_service.dart';
import 'package:{{packageName.snakeCase()}}/feedback/services/vibrate_service.dart';
import 'package:{{packageName.snakeCase()}}/home/routers/home_router.dart';
import 'package:{{packageName.snakeCase()}}/home/views/home/home_view_model.dart';
import 'package:{{packageName.snakeCase()}}/localizations/strings/gen/l10n.dart';
import 'package:{{packageName.snakeCase()}}/settings/apis/settings_api.dart';
import 'package:{{packageName.snakeCase()}}/settings/services/settings_service.dart';
import 'package:{{packageName.snakeCase()}}/settings/views/settings_view_model.dart';
import 'package:{{packageName.snakeCase()}}/state/views/placeholder/placeholder_router.dart';
import 'package:{{packageName.snakeCase()}}/state/views/placeholder/placeholder_view_model.dart';
