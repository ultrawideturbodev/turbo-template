...
import 'package:{{packageName.snakeCase()}}/auth/views/accept_privacy/accept_privacy_view.dart';
import 'package:{{packageName.snakeCase()}}/auth/views/auth/auth_view.dart';
import 'package:{{packageName.snakeCase()}}/auth/views/create_username/create_username_view.dart';
import 'package:{{packageName.snakeCase()}}/auth/views/forgot_password/forgot_password_view.dart';
import 'package:{{packageName.snakeCase()}}/auth/views/verify_email/verify_email_view.dart';
...
import 'package:{{packageName.snakeCase()}}/routing/models/extra_arguments.dart';
import 'package:{{packageName.snakeCase()}}/routing/enums/navigation_tab.dart';
import 'package:{{packageName.snakeCase()}}/data/extensions/object_extension.dart';
import 'package:{{packageName.snakeCase()}}/data/extensions/string_extension.dart';
import 'package:{{packageName.snakeCase()}}/routing/services/navigation_tab_service.dart';
import 'package:{{packageName.snakeCase()}}/ui/config/transition_builders.dart';
...
import 'package:{{packageName.snakeCase()}}/routing/shell/shell_view.dart';
