...
import 'package:turbo_template/core/extensions/date_time_extension.dart';
...
import '../../../core/enums/step_result.dart';
import '../../../core/exceptions/unexpected_state_exception.dart';
import '../../../core/globals/g_now.dart';
import '../../../core/services/feedback_service.dart';
import '../../../core/services/local_storage_service.dart';
import '../apis/usernames_api.dart';
import '../apis/users_api.dart';
import '../routing/auth_step_router.dart';
    ...
    if (didNotCreateSettingsDoc) {
      ...
      if (hasSettings) {
        ...
        final response = await _settingsService.createSettings(
          settingsDto: SettingsDto.defaultDto(
            userId: userId,
          ),
        );
